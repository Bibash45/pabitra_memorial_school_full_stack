  ...
  const schoolFAQ = [
    {
      question: "Book Info",
      answer:
        "Explore the application process for admission to Pabitra Memorial School on our Admissions page. Find all necessary forms and instructions to start your journey with us.",
      file: File1,
    },
    {
            ...
            <Accordion.Content className="text-black">
              ...
              <button>
                <a
                  ...
                  className="flex items-center justify-start gap-2 bg-primary-500  py-2 px-2 rounded-md hover:bg-primary-400 transition-all duration-300 text-white"
                >
                  <FaCloudDownloadAlt />
                  <span>Open</span>
                </a>
