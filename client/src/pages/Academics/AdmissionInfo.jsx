...
const AdmissionInfo = () => {
  const schoolFAQ = [
    {
      question: "How do I apply for admission to Pabitra Memorial School?",
      answer:
        "To apply for admission to Pabitra Memorial School, please visit our Admissions page and follow the step-by-step application process outlined there. You'll find all the necessary forms and instructions to get started.",
    },
    {
      question:
        "What are the admission requirements for Pabitra Memorial School?",
      answer:
    ...
    {
      question:
        "Are there any entrance exams for admission to Pabitra Memorial School?",
      answer:
    ...
    {
      question: "What is the tuition fee for Pabitra Memorial School?",
      answer:
        "Tuition fees vary depending on the grade level and program. Our Tuition and Fees page provides a detailed breakdown of tuition costs and  fees.",
    },
    {
      question:
        "Can I schedule a tour or visit Pabitra Memorial School before applying for admission?",
      answer:
    ...
    {
      question:
        "How can I check the status of my child's application to Pabitra Memorial School?",
      answer:
    ...
    {
      question:
        "What is the enrollment process after admission is offered at Pabitra Memorial School?",
      answer:
    ...
    {
      question:
        "Is transportation available for students who live outside the immediate area of Pabitra Memorial School?",
      answer:
        "Sorry, we does not offer transportation services for students who live outside the immediate vicinity of Pabitra Memorial School.",
    },
  ];
