    ...
    <Timeline className=" flex flex-col  w-[100%] lg:m-10 ml-7 ">
      ...
      <Timeline.Item>
        ...
        <Timeline.Content className="w-[80%]">
          ...
          <Timeline.Body>
          The gates of Knowledge of Pabitra Memorial School was opened to the students. It was an amazing journey of catering  wisdom to students to excel in all walks of life.
          </Timeline.Body>
          {/* <Button color="gray">
            Learn More
      ...
      <Timeline.Item>
        ...
        <Timeline.Content className="w-[80%]">
          ...
          <Timeline.Body>
           We underwent a significant transformation and rebranded our school from Mount Litera Zee School to Pabitra Memorial School
          </Timeline.Body>
        </Timeline.Content>
      </Timeline.Item>
    </Timeline>
