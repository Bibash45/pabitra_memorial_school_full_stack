  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col gap-5 p-5 bg-secondary pb-[6rem] tracking-wide py-20">
        ...
        >
          At Pabitra Memorial School, our mission is to offer affordable,
        ...
        <div className="relative w-full">
          <button
            className=" xl:hidden absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded-l-md z-10"
          ...
          <div
            ref={cardsRef}
            className="flex gap-8 w-full items-center h-auto overflow-x-hidden scroll-smooth scrollbar-hide justify-center"
          ...
          <button
            className="xl:hidden absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded-r-md z-10"
