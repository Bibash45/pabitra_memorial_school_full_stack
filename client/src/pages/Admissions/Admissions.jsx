...
const Admissions = () => {
  ...
  return (
    <div className="h-[10vh] mt-[4rem]  ">
      <Helmet>
  <title>Admissions | Pabitra Memorial School</title>
  <meta
    name="description"
    content="Explore the admissions process at Pabitra Memorial School. Find details on eligibility, application procedures, and how to enroll your child."
  />
</Helmet>
      ...
      <Hero 
        text={"ADMISSION INFO"}
        image={image}
        description={`A warm welcome to the Pabitra Memorial School! We are excited to extend an invitation
        ...
        impressive ranking in the education world. The dedicated admission team at PMEBS is here to
