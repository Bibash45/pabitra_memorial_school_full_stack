...
const OurTeam = () => {
  return (
    ...
    <Helmet>
      <title>Our Team | Pabitra Memorial School</title>
      <meta
        name="description"
        content="Meet the dedicated educators and staff at Pabitra Memorial School, committed to fostering a nurturing learning environment for every student."
      />
