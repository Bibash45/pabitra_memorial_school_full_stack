...
const OurManagementPeople = () => {
  const data = [
    ...
    //       icon: <FaInstagram className="text-4xl hover:cursor-pointer hover:bg-gradient-to-r hover:from-primary-500 hover:via-primary-500 hover:to-pink-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md instagram-icon" />,
    //     },
    //     {
    //       platform: "Facebook",
    //       link: "https://www.facebook.com/mlzsmys/",
    //       icon: <FaFacebook className="text-4xl hover:cursor-pointer hover:bg-primary-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md" />,
    //     },
    ...
    // },
    {
      ...
      socialMedia: [
        ...
        {
          platform: "Facebook",
          link: "https://www.facebook.com/cool.unique.7",
          icon: <FaFacebook className="text-4xl hover:cursor-pointer hover:bg-primary-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md" />,
        },
        /* Add more social media objects here if needed */
      ],
    },
    {
      ...
      socialMedia: [
        ...
        {
          platform: "Facebook",
          link: "https://www.facebook.com/drugist.kto.9",
          icon: <FaFacebook className="text-4xl hover:cursor-pointer hover:bg-primary-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md" />,
        },
        /* Add more social media objects here if needed */
      ],
