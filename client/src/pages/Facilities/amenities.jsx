...
const FacilityCard = () => {
  ...
  return (
    <div className="container mx-auto mt-10 py-10 text-textSecondary">
      ...
      >
        Explore our exceptional amenities at Pabitra Memorial School, enhancing student life with a modern swimming pool for relaxation and fitness, and a state-of-the-art sports arena for diverse activities.
      </motion.p>
