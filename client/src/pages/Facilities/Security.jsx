...
const Security= () => {
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            At Pabitra Memorial School (MIS), the safety and well-being of our students are paramount. We understand that a secure learning environment is essential for fostering personal and academic growth. 
            </p>
            <a
              href="#features"
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
              ...
              <div className="p-4 md:p-6">
                ...
                Pabitra Memorial School is more than just an educational institution; it's a second home for our students. Our Safety and Security Department is dedicated to cultivating an atmosphere of trust and enhancing the quality of life within our diverse educational community. 
                </p>
              </div>
            </li>
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    Join us at Pabitra Memorial School, where student safety is our top priority. Enroll now and experience a learning environment that prioritizes security, trust, and well-being.
    </p>
    <a
      href="#"
