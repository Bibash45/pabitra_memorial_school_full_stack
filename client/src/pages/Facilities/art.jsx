...
const Art = () => {
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            Pabitra Memorial School's Art and Design Department is dedicated to nurturing creativity and artistry among students, providing them with a platform to explore their artistic passions. 
            </p>
            <a
              href="#features"
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <img
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                The Visual Arts Program at Pabitra Memorial School begins from Kindergarten and offers a comprehensive approach to learning art. Students engage in art-making activities, study art history, participate in critiques, and reflect on their creative processes. 
                </p>
              </div>
            </li>
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    Join us at Pabitra Memorial School and unleash your artistic potential. Enroll now to be part of a vibrant artistic community that celebrates creativity, innovation, and artistic excellence!
    </p>
    <a
      href="#"
