...
const ScienceLab = () => {
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            The study of science at Pabitra Memorial School goes beyond theoretical knowledge; it's about hands-on exploration and discovery. 
            </p>
            <a
              href="#features"
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    Join us at Pabitra Memorial School and embark on a scientific journey filled with exploration, experimentation, and discovery. Enroll now and be part of a vibrant learning community that values hands-on learning and scientific inquiry.
    </p>
    <a
      href="#"
