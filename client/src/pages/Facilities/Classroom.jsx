...
const Classroom = () => {
    ...
    <div className="min-h-screen flex flex-col pt-11 md:pt-0">
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            At Pabitra Memorial School, we understand that learning goes beyond academics. Our classroom facilities are designed to create an environment conducive to holistic growth, critical thinking, and creativity among our students.
            </p>
            <a
              href="#features"
      ...
      <div className="py-8 md:py-16 bg-gray-100" id="features">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          Classroom Facilities at Pabitra Memorial School
          </h2>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <img
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                At Pabitra Memorial School, we strongly believe in the power of hands-on learning as a transformative educational approach. Our curriculum is designed to provide students with ample opportunities for practical, experiential learning that goes beyond traditional classroom instruction.
                </p>
              </div>
            </li>
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
            <img
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                Smart classrooms at Pabitra Memorial School are equipped with interactive whiteboards, Smart displays, and multimedia resources. These tools enable teachers to deliver engaging lessons that capture students' attention and encourage active participation.
                </p>
              </div>
            </li>
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
            <img
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                Students have the opportunity to At Pabitra Memorial School, we prioritize the holistic development of our students, which includes fostering an eco-friendly environment. Our classrooms are designed with sustainability in mind, incorporating eco-friendly practices and materials wherever possible.
                </p>
              </div>
            </li>
          </ul>
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    By joining Pabitra Memorial School, students not only excel academically but also develop essential life skills, leadership qualities, and a passion for lifelong learning. Join us in creating a dynamic and enriching learning environment for your child.
    </p>
    <a
      href="#"
