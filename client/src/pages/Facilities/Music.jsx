...
const Music = () => {
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            The music program at Pabitra Memorial School is designed to ignite a passion for music, nurture artistic talents, and cultivate a deep appreciation for musical expression among our students. 
            </p>
            <a
              href="#features"
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    Join us at Pabitra Memorial School and discover the joy of music, creativity, and artistic expression. Experience the power of music in shaping minds, touching hearts, and creating unforgettable memories.
    </p>
    <a
      href="#"
