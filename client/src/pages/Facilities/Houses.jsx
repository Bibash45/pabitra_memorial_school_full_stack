        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10 rounded-md bg-opacity-70">
            <h1 className="text-2xl md:text-4xl font-bold font-title tracking-wide text-secondary mb-2">
              Houses at Pabitra Memorial School
            </h1>
            <p className="text-sm md:text-lg max-w-3xl text-secondary font-description pb-6 tracking-wide">
              At Pabitra Memorial School, we believe in nurturing more than just academic excellence. Our mission is to foster holistic growth, leadership, and a sense of community among our students.
            </p>
            <a
              href="#houses"
          ...
          <ul className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <li className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer">
              ...
              <div className="p-4 md:p-6 bg-blue-700">
                <h3 className="text-lg md:text-xl font-bold text-white mb-2">
                  Columbus ( primary House )
                </h3>
                <p className="text-white text-sm md:text-base">
                  The primary emblem stands for unity and compassion. primary represents trust, responsibility, and the sense of belonging to a larger community.
                </p>
              </div>
            </li>
      ...
      {/* Closing Section */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-600 text-lg mb-10 ">
            At Pabitra Memorial School, we prepare our students not only for academic success but for leadership in life. Unlock your potential, grow as a leader, and embrace the rich diversity of our school community through our Houses System.
          </p>
          <a
            href="#"
