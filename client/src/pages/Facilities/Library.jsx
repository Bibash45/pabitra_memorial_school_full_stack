...
const Library = () => {
      ...
      <div className="relative h-[330px] lg:h-[550px]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-4xl mx-4 px-3 text-center bg-white p-10   rounded-md bg-opacity-70">
            ...
            The library at Pabitra Memorial School is a cornerstone of knowledge and learning for our students. 
            </p>
            <a
              href="#features"
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    Join us at Pabitra Memorial School and immerse yourself in a world of knowledge, curiosity, and innovation through our vibrant library services. Unlock the doors to a brighter future filled with endless possibilities.
    </p>
    <a
      href="#"
