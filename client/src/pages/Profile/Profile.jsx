          ...
          <div className="grid grid-cols-1 md:grid-cols-2 h-full">
            ...
            <div className="flex flex-col justify-center p-4">
              ...
              <div className=" space-y-4 lg:space-y-0 lg:flex items-center justify-start gap-2 mt-4">
                {/* <button className=" hover:-translate-y-2  flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-all duration-300">
                  <FaEdit />
                  <span>Update Profile</span>
                </button> */}
                <button onClick={handleProfilePicUpdateModalOpen} className="hover:-translate-y-2   flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition-all duration-300">
                  <FaCamera />
