 ...
 return (
   <div className=" w-[100%] pt-8 flex  flex-col mt-[150px] md:mt-[30px] lg:mt-[100px]">
     ...
     <section className="mb-12 mt-[2rem] text-center">
      <h2 className="text-3xl font-bold text-secondary font-tile mb-4">BLE Program Overview</h2>
      <p className="text-lg text-secondary mb-4 px-10">
        The Basic Level Examinaton (BLE) curriculum at Pabitra Memorial School is designed to provide a comprehensive learning experience across various disciplines.
      </p>
    ...
    <section className='p-10'>
      <h2 className="text-[20px] sm:text-[24px] md:text-center lg:text-[28px]  font-bold text-textSecondary mb-4 text-start">5 E's of Enhanced Learning Experience at PMEBS</h2>
      <div className="">
