...
import logo from '../../assets/Images/LogoAndOthers/pabitralogo2.png';
        ...
        <div>
          ...
          >
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-title">
              Welcome to <span className="font-subtext">PMEBS</span>
            </h1>
          ...
          <p className="text-justify font-sans tracking-wide font-normal mb-3">
            Welcome to Pabitra Memorial School, a place where every
