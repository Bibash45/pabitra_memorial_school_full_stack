      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row justify-between p-10 gap-[10px] lg:gap-[110px]">
          ...
          className="lg:w-1/2 w-xl mr-10">
            ...
            <h2 className="font-title text-3xl lg:text-4xl font-bold lg:mb-3 tracking-wide text-secondary">Join the BLE Community Through PMEBS.</h2>
            ...
            <div className="grid grid-cols-2 gap-6 lg:gap-8">
              <div className="col max-mb-60">
                <div>
                  ...
                  <h2 className="font-description tracking-wider text-xl lg:text-2xl text-secondary">STUDENTS</h2>
                </div>
              </div>
              {/* <div className="col max-mb-60">
                <div>
              ...
              <div className="col max-mb-60" >
                <div className="funfact">
                  {/* <div className="number"><span className="counter text-secondary text-2xl font-black font-Bnumber"></span></div> */}
                  <h6 className="font-description tracking-wide text-xl lg:text-2xl text-secondary">
                  By being a part of PMEBS, students gain the opportunity to expand their horizons, achieve academic excellence, and develop both personally and socially.
                  </h6>
                </div>
              </div>
              {/* <div className="col max-mb-60" >
