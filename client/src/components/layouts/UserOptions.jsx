  ...
  <>
    ...
    >
      ...
      <SpeedDial
        ...
        icon={<img src={user?.avatar?.url} alt="" className="rounded-full w-full h-full border-[2px] border-yellow-500  border-spacing-2 object-cover shadow-xs shadow-amber-400" />}
        onClose={handleClose}
        onOpen={handleOpen}
        open={open}
        direction="down"
