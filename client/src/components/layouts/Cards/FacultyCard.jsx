    ...
    socialMedia.map((social, index) => (
      ...
      >
        {social.platform === "Instagram" && (
          <FaInstagram className="mr-1 text-4xl hover:cursor-pointer hover:bg-gradient-to-r hover:from-primary-500 hover:via-primary-500 hover:to-pink-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md instagram-icon" />
        )}
        {social.platform === "Facebook" && (
          <FaFacebook className="mr-1 text-4xl hover:cursor-pointer hover:bg-primary-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md" />
        )}
      </a>
    ))}
</div>
