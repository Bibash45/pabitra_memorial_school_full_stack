        ...
        <div className="text-textSecondary ">
          <div className="flex gap-3 mt-3">
            <Link to="https://drjosephthomas.com/" >
              <BsGlobe2 className="text-4xl hover:cursor-pointer hover:bg-gradient-to-r hover:from-primary-500 hover:via-primary-500 hover:to-pink-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md instagram-icon"></BsGlobe2>
            </Link>
            <Link to="https://www.linkedin.com/in/drjosephthomas/">
              <BsLinkedin className="text-4xl hover:cursor-pointer hover:bg-gradient-to-r hover:bg-primary-700 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md instagram-icon"></BsLinkedin>
            </Link>
            <Link to="https://www.instagram.com/mlzs_mysore/">
              <FaInstagram className="text-4xl hover:cursor-pointer hover:bg-gradient-to-r hover:from-primary-500 hover:via-primary-500 hover:to-pink-500 transition-all duration-300 hover:scale-110 hover:text-white p-2 rounded-md instagram-icon"></FaInstagram>
            </Link>
