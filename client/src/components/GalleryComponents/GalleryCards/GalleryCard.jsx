    ...
    {isAdmin && (
      <>
        ...
        <FaPen
          ...
          title="Edit News"
          className="text-primary-600 absolute top-[3px] text-md right-8 m-2 hover:cursor-pointer hover:scale-110 transition-all duration-200 hover:text-primary-500 z-20"
        />
      </>
    )}
