...
import VisitScheduleAdmin from "./AdminPages/VisitScheduleAdmin";
        ...
        <Routes>
          ...
          <Route path="/login" element={<Login />} />
            ...
            <Route path="/admin-users" element={<AdminUsers />} />
              ...
              <Route path="/visit-schedule" element={<VisitScheduleAdmin />} />
              ...
              <Route path="/add-gallary" element={<Gallery />} />
              <Route path="/add-awards" element={<Awards />} />
            </Route>
          </Route>
