...
router.route("/visitSchedule").get(isAuthenticatedUser, isAdmin, getAllVisitSchedule)
router.route("/visitSchedule/:id").delete(isAuthenticatedUser, isAdmin, deleteScheduleVisit)
